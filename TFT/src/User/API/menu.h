...
#define ITEM_PER_PAGE_CM_4  4 //cremaker
#define ITEM_PER_PAGE_CM_3  3 //cremaker
...
extern const GUI_RECT rect_of_key[MENU_RECT_COUNT];
  ...
  extern const GUI_RECT rect_of_keySSCM[ITEM_PER_PAGE_CM_4];
#else
  extern const GUI_RECT rect_of_keySSCM[ITEM_PER_PAGE_CM_3];
#endif
