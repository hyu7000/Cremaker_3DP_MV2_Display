...
const GUI_RECT rect_of_ILC[MENU_RECT_COUNT] = {
  ...
  const GUI_RECT rect_of_keySSCM[ITEM_PER_PAGE_CM_4] = {
#else
  const GUI_RECT rect_of_keySSCM[ITEM_PER_PAGE_CM_3] = {
#endif
  //     x0             y0                     x1                                y1
  ...
  #ifdef CREMAKER_CHAMBER
    {SS_MAINLOGO_X, SS_MAINLOGO_Y, SS_MAINLOGO_X + MAINLOGO_W, SS_MAINLOGO_Y + MAINLOGO_H},  // cremaker chamber LED on/off
  #endif
};

#ifdef CREMAKER_CHAMBER
  const GUI_RECT rect_of_keyPSCM[ITEM_PER_PAGE_CM_4] = {
#else
  const GUI_RECT rect_of_keyPSCM[ITEM_PER_PAGE_CM_3] = {
#endif
  ...
  #ifdef CREMAKER_CHAMBER
    {PS_MAINLOGO_X, PS_MAINLOGO_Y, PS_MAINLOGO_X + PS_MAINLOGO_W, PS_MAINLOGO_Y + PS_MAINLOGO_H},  // cremaker chamber LED on/off
  #endif
};
...
KEY_VALUES menuKeyGetValue(void)
{
  ...
  {
    if(infoMenu.menu[infoMenu.cur] != menuAddZOffsetCal)
      titleBarPress();
    return KEY_IDLE;
  }
  else
