...
void menuInfo(void)
{
  ...
  const char *const firmware = CREMAKER_DISPLAY_VERSION"." STRINGIFY(SOFTWARE_VERSION) " " __DATE__;
  ...
  //draw titles
  GUI_DispString(0, version[0].y0, (uint8_t *)"Fw 종류  :");
  GUI_DispString(0, version[1].y0, (uint8_t *)"메인 Fw  :");
